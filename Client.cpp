...
int main()
{
    ...
    fcntl(sockCli, F_SETFL, flags | O_NONBLOCK);
    flags = fcntl(sockConn, F_GETFL, 0);
    fcntl(sockConn, F_SETFL, flags | O_NONBLOCK);
#endif
    ...
    while (!glfwWindowShouldClose(window))
        {
            ...
            ImGui::InputInt(" Port (4000 - 60000) ", &connPort);
                            ...
                            if (console.inputFlag)
                                {
                                    ...
                                    send(sockConn, console.sendBuf, strlen(console.sendBuf) + 1,
                                         MSG_DONTWAIT);
                                }
